...
![IRM 시스템 설계도: 로컬 및 AWS 수집, Google Sheets 검토, Fargate 메일 발송과 운영 지원](assets/irm-system-design.png)

시스템 설계 요약 · Naver·Instagram 수집은 로컬, YouTube 수집·메일 발송은 AWS Fargate에서 실행합니다. Google Sheets로 검토·상태·발송 이력을 연결합니다.
