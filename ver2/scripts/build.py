...
<main><section id="intro" class="intro"><p class="eyebrow">KIM DONGHAK / FRONTEND · PRODUCT ENGINEER</p><h1>화면에서 시작해,<br>업무가 끝나는 곳까지.</h1><p class="bio"><strong>안녕하세요, 김동학입니다.</strong><br>{e(D['intro'])}</p><p class="value">사용자가 일을 끝낼 수 있는 흐름을 만듭니다.<br>화면의 사용성, 데이터 연결, 운영의 제약을 함께 살핍니다.</p>
